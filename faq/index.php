          ...
          <div class="w-full px-4 lg:w-1/2">
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                ...
                Students from AICTE recognised colleges and Universities can participate in
Hackathon 23.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
 No, Spot registration is not possible.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                  Will the registration fee be refunded, if a team quits from the event?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
          ...
          <div class="w-full px-4 lg:w-1/2">
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                  Will all participants get appreciation?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                Top 3 teams will be announced as winners and will be given cash prize
accordingly. All the participants will be given a participation certificate.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                  Will Internet facilities be provided?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
