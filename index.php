      ...
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          ...
          <div class="flex w-full items-center justify-between px-4">
                ...
                <ul class="blcok lg:flex">
                  ...
                  <li class="submenu-item group relative">
                    ...
                    <div class="submenu relative top-full left-0 hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                      <a href="/rules-and-regulations/" class="block rounded py-[10px] px-4 text-sm text-body-color hover:text-primary">
                        Rules
                      </a>
                      <a href="/faq" class="block rounded py-[10px] px-4 text-sm text-body-color hover:text-primary">
                        FAQ
                      </a>
                      <a href="/contact" class="block rounded py-[10px] px-4 text-sm text-body-color hover:text-primary">
                        Contact
                      </a>
            ...
            <div class="hidden blk justify-end pr-16 sm:flex lg:pr-0 " style="margin-left: 195px;display: none;">
            </div>
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
                  ...
                  <img src="assets/images/logo/logo.png" alt="Hackathon 23">
                 
                    
                  </h1>
              <p 
                class="mrg-top mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed"
              >
              Hackathon' 23 is a national level hackathon organized by Jeppiaar Engineering College in
collaboration with the Department of CSE , Department of AIDS and Department of IT in
